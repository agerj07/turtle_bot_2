...
main( int argc, char* argv[] ){
	...
	//ros::Subscriber depth_image_subscriber = node_handle.subscribe( "camera/
		//depth/image_raw", 1, &Perception::handleDepthImage, &perception );
	ros::Publisher observations_publisher = node_handle.advertise< perception::
		Observations >( "observations", 1, true );
